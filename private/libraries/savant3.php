...
class Savant3 {
	...
	*/
	...
	/**
	* 
	* Captures a template directly (equivalent to <code>echo $tpl</code>).
	* 
	* @access public
	* 
	* @param string $tpl The template source to compile and capture.
	* 
	* @return void
	* 
	*/
	
	public function capture($tpl = null)
	{
