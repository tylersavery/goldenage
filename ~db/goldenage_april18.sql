...
--
-- Host: localhost
-- Generation Time: Apr 18, 2012 at 12:23 PM
...
INSERT INTO `articles` VALUES(320, 57, 9, 'The 10 Greatest B-52''s Songs1', 'While we would like to contrive some sort of cosmic reason for compiling this list today, we confess: We got â€œMesopotamiaâ€ stuck in our heads yesterday, while walking into the office kitchen, and that was motivation enough.', 'All of these tunes are available on 2002â€™s excellent two-disc Rhino set Nude On The Moon: The B-52â€™s anthology. Put it on, have a flaming volcano and enjoy.', 'the-10-greatest-b-52s-songs1', 'e02c17d41b9c9c03f41f72bb4ab57913', 'http://bit.ly/zpj9tu', NULL, NULL, '', '', 1330981303, 1330977600, NULL, 'a');
INSERT INTO `articles` VALUES(321, 57, 9, 'The Beatles Land in New York City', 'The Beatles arrived in America on February 7, 1964, ', 'The Beatles arrived in America on February 7, 1964,&nbsp;and made the first of three consecutive appearances on the "Ed Sullivan Show" two days later. The Ed Sullivan Theater, at 1697 Broadway, is now the Late Show with David Letterman Theater. The Beatles stayed at the upscale Plaza Hotel, where their comings &amp; goings were marked by screams from frantic teenagers (to the horror of the hotel staff). The Plaza is on Central Park South at Fifth Avenue.', 'the-beatles-land-in-new-york-city', '874b921e9fd5eecf295ed201bcaf4321', 'http://bit.ly/wsKgZ0', NULL, NULL, '', '', 1330987872, 1330985520, NULL, 'a');
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=4125 ;
...
INSERT INTO `images` VALUES(4074, 2, '2086b2f266820af9be4fdf6edfc6aa84', '2086b2f266820af9be4fdf6edfc6aa84_main.png', 'png', 555660, 600, 308, 101, 105, 1208, 674, 1323712348, 1330984265, 'a');
INSERT INTO `images` VALUES(4075, 3, '2086b2f266820af9be4fdf6edfc6aa84', '2086b2f266820af9be4fdf6edfc6aa84_thumbnail.png', 'png', 265952, 340, 260, 153, 0, 1092, 718, 1323712349, 1330984270, 'a');
...
INSERT INTO `users` VALUES(57, 'tyler@theyoungastronauts.com', '2e5a5e5846a573f721b5b987d5dcba44', 'Tyler', 'Savery', '', NULL, NULL, NULL, 'a', 7);
